...
function createRender(options) {
    var hostCreateElement = options.createElement, hostPatchProp = options.patchProp, hostInsert = options.insert, hostSetElementText = options.setElementText, hostRemove = options.remove;
    ...
    function patchChildren(n1, n2, container, parentComponent) {
        var pervShapeFlag = n1.shapeFlag;
        var c1 = n1.children;
        var shapeFlag = n2.shapeFlag;
        var c2 = n2.children;
        if (shapeFlag & 4 /* TEXT_CHILDREN */) {
            if (pervShapeFlag & 8 /* ARRAY_CHILDREN */) {
                unmountChildren(c1);
            }
            hostSetElementText(n2.el, c2);
        }
        else {
            if (pervShapeFlag & 4 /* TEXT_CHILDREN */) {
...
export { createApp, createAppAPI, createRender, createText, getCurrentInstance, h, inject, provide, proxyRefs, ref, renderSlots };
